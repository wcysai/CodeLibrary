...
const int rt=basics::power(2,(mod-1)/7,mod);
 
const int maxn=1000007;
const int mx=basics::power(7,7,mod);
int pw[7],n,k;
int a[maxn],c[maxn];
...
signed main(){
    ...
    rep(i,mx) c[i]=basics::power(c[i],k,mod);
    int res=0;
    rep(i,mx) res=(res+c[i])%mod;
    cout<<res*basics::power(mx,mod-2,mod)%mod;
    return 0;
}